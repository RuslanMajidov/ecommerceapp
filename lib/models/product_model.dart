...
class Product extends Equatable{
  ...
  static List<Product> products =[
    ...
    Product(name: 'Multicolor Shoes',
        category: 'Shoes',
        imageUrl: 'https://i.pinimg.com/736x/88/74/e7/8874e7a0aace168049eafde28427ce8f.jpg',
        price: 1200,
        ProductList: true),
    Product(
      name: "Toddler Shoes",
    ...
    Product(
      ...
      category: 'Goggles',
      imageUrl:
          'https://m.media-amazon.com/images/I/61lfZ8PK6pL._UL1500_.jpg',
      price: 200,
      ProductList: true,
    ),
    Product(
...
'https://5.imimg.com/data5/NM/II/MY-3020503/ladies-hand-bags1-500x500.jpg',
    ...
    Product(
      ...
      category: 'Hand Bags',
      imageUrl:
          'https://m.media-amazon.com/images/I/416u+59IJ3L.jpg',
      price: 200,
      ProductList: true,
    ),
    Product(
